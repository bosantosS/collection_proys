...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    print('Redondeo>>> ${(3.5).round()}');
    print('Redondeo>>> ${(3.2).round()}');
    print('Redondeo>>> ${(3.7).round()}');
    print('Redondeo>>> ${(3.0).round()}');
    print('Redondeo>>> ${(3).round()}');

    print('Redondeo>>> ${(3.5).round() / (3.5)}');
    print('Redondeo>>> ${(3.2) / (3.2).round()}');
    print('Redondeo>>> ${(3.5).round() % (3.5)}');
    print('Redondeo>>> ${(3.2) % (3.2).round()}');
    print('Redondeo>>> ${(3).round()}');
